...
User.create!(:first_name => "Temp", :last_name => "Admin", :uin => 100000000, :user_type => :admin, :email => "temp@admin.com", :password => "TempPassword").confirm

if Rails.env.development?
  User.create!(:first_name => "Test", :last_name => "Admin", :uin => 100000001, :user_type => :admin, :email => "admin@test.com", :password => "AdminPassword").confirm
  User.create!(:first_name => "Test", :last_name => "Executive", :uin => 100000002, :user_type => :executive, :email => "exec@test.com", :password => "ExecPassword").confirm
  User.create!(:first_name => "Test", :last_name => "Staff", :uin => 100000003, :user_type => :staff, :email => "staff@test.com", :password => "StaffPassword", :committee => pr_committee).confirm

  # CR Committee
  User.create!(:first_name => "CR", :last_name => "Mentor", :uin => 100000007, :user_type => :staff, :email => "CRMentor@test.com", :password => "CRMentorPassword", :committee => campus_relations_committee).confirm
  User.create!(:first_name => "CR", :last_name => "Freshman1", :uin => 100000008, :user_type => :base, :email => "CRFreshman1@test.com", :password => "CRFreshman1Password", :committee => campus_relations_committee).confirm
  User.create!(:first_name => "CR", :last_name => "Freshman2", :uin => 100000009, :user_type => :base, :email => "CRFreshman2@test.com", :password => "CRFreshman2Password", :committee => campus_relations_committee).confirm
  User.create!(:first_name => "CR", :last_name => "Freshman3", :uin => 100000010, :user_type => :base, :email => "CRFreshman3@test.com", :password => "CRFreshman3Password", :committee => campus_relations_committee).confirm
